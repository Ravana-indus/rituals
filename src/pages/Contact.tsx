  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col relative">
        ...
        <section className="max-w-7xl mx-auto px-6 mb-24 relative z-10">
          <div className="flex flex-col md:flex-row items-end justify-between gap-8 border-b border-outline-variant/15 pb-16">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl md:text-7xl font-noto-serif text-primary leading-tight mb-8">Contact Us</h1>
              <p className="text-lg text-on-surface-variant font-manrope leading-relaxed">
                Whether you are looking for specific international brands or need help building your daily personal care routine, our team is here to help.
              </p>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-20 relative z-10">
          ...
          <div className="lg:col-span-7 bg-surface-container-low p-8 md:p-12 rounded-xl">
            ...
            <form className="space-y-10">
              <div className="relative">
                <label className="block text-xs font-manrope uppercase tracking-widest text-on-surface-variant mb-2">Your Name</label>
              ...
              <div className="relative">
                <label className="block text-xs font-manrope uppercase tracking-widest text-on-surface-variant mb-2">Email Address</label>
              ...
              <div className="relative">
                <label className="block text-xs font-manrope uppercase tracking-widest text-on-surface-variant mb-2">Your Message</label>
          ...
          <div className="lg:col-span-5 space-y-16">
            ...
            <div className="space-y-12">
              <div className="group">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-noto-serif text-primary mb-1">Speak with our Team</h3>
              ...
              <div className="group">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-noto-serif text-primary mb-1">Email Us</h3>
                    <p className="text-sm text-on-surface-variant leading-relaxed">
                      For detailed requests and wholesale inquiries.<br/>
                      <a className="text-on-surface font-semibold hover:text-secondary transition-colors" href="mailto:hello@rituals.lk">hello@rituals.lk</a>
                    </p>
                  </div>
                </div>
              </div>
              <div className="group">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-noto-serif text-primary mb-1">Visit Us</h3>
                    <p className="text-sm text-on-surface-variant leading-relaxed mb-4">
                      Find your favorite affordable personal care products at our store.<br/>
            ...
            <div className="border-t border-outline-variant/15 pt-12">
              <h4 className="text-xs font-manrope uppercase tracking-[0.3em] text-on-surface-variant mb-6">Social Media</h4>
              ...
              <div className="w-24 h-24 flex items-center justify-center relative">
                <svg className="absolute inset-0 w-full h-full text-tertiary-container animate-[spin_20s_linear_infinite]" viewBox="0 0 100 100">
                  ...
                  <text className="text-[8px] uppercase tracking-[0.1em] fill-on-primary">
                    <textPath href="#circlePath">Authenticity Guaranteed • Affordable Personal Care •</textPath>
                  </text>
                </svg>
                <Icon name="verified" filled className="text-on-primary-container text-4xl" />
              </div>
            </div>
            <h3 className="text-2xl font-noto-serif text-primary mb-4 italic">Affordable Personal Care</h3>
            <p className="max-w-xl text-on-surface-variant text-sm font-manrope leading-relaxed">
              We are committed to bringing you the best international brands at affordable prices. Authentic products for your daily routine.
            </p>
          </div>
        </section>
      </main>
      ...
      <footer className="w-full mt-auto bg-surface-container flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8">
        <div className="font-noto-serif text-lg font-semibold text-on-surface">Rituals.lk</div>
        ...
        <div className="font-manrope text-xs uppercase tracking-[0.2em] text-primary text-center md:text-right">
          © 2024 Rituals.lk. Affordable Personal Care in Sri Lanka.
        </div>
      </footer>
    </div>
  );
