...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      order_items: {
        Row: { created_at: string | null; id: string; order_id: string; product_id: string; product_name: string; quantity: number; total_cents: number; unit_price_cents: number; variant_id: string | null; variant_name: string | null }
        Insert: { created_at?: string | null; id?: string; order_id: string; product_id: string; product_name: string; quantity: number; total_cents: number; unit_price_cents: number; variant_id?: string | null; variant_name?: string | null }
        Update: { created_at?: string | null; id?: string; order_id?: string; product_id?: string; product_name?: string; quantity?: number; total_cents?: number; unit_price_cents?: number; variant_id?: string | null; variant_name?: string | null }
        Relationships: [
      ...
      orders: {
        Row: { billing_address_id: string | null; created_at: string | null; discount_cents: number | null; email: string; id: string; notes: string | null; order_number: string; payhere_payment_id: string | null; payment_method: string | null; payment_status: string | null; shipping_address_id: string | null; shipping_cents: number | null; status: string | null; subtotal_cents: number; tax_cents: number | null; total_cents: number; updated_at: string | null; user_id: string | null }
        Insert: { billing_address_id?: string | null; created_at?: string | null; discount_cents?: number | null; email: string; id?: string; notes?: string | null; order_number: string; payhere_payment_id?: string | null; payment_method?: string | null; payment_status?: string | null; shipping_address_id?: string | null; shipping_cents?: number | null; status?: string | null; subtotal_cents: number; tax_cents?: number | null; total_cents: number; updated_at?: string | null; user_id?: string | null }
        Update: { billing_address_id?: string | null; created_at?: string | null; discount_cents?: number | null; email?: string; id?: string; notes?: string | null; order_number?: string; payhere_payment_id?: string | null; payment_method?: string | null; payment_status?: string | null; shipping_address_id?: string | null; shipping_cents?: number | null; status?: string | null; subtotal_cents?: number; tax_cents?: number | null; total_cents?: number; updated_at?: string | null; user_id?: string | null }
        Relationships: [
          { foreignKeyName: "orders_billing_address_id_fkey"; columns: ["billing_address_id"]; referencedRelation: "addresses"; referencedColumns: ["id"] },
          { foreignKeyName: "orders_shipping_address_id_fkey"; columns: ["shipping_address_id"]; referencedRelation: "addresses"; referencedColumns: ["id"] },
